...
public static class BulkActions
{
    ...
    public static string Season { get; set; } = "Tales of Transformation";
    public static PogoDate SeasonEnd { get; set; } = new PogoDate(2025, 12, 02);
    ...
    public static void AddMonthlyRaidBosses(PogoEncounterList list)
    {
        ...
        static bool IsLessRestrictiveEncounter(PogoType type) => type is Wild or ResearchBreakthrough or SpecialResearch or TimedResearch or CollectionChallenge or (>= (PogoType)31 and <= (PogoType)69);
    }
